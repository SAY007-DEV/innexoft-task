  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '80vh', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', gap: '2rem' }}>
        ...
        <button onClick={() => navigate('/employee')} style={{ padding: '1rem 2rem', fontSize: '1.2rem', borderRadius: '8px', border: 'none', background: '#388e3c', color: 'white', cursor: 'pointer' }}>Employee</button>
      </div>
    </div>
  )
}
